<div class="task cardInter {{ $tarefa->status == App\Models\Tarefa\StatusTarefa::A_FAZER ? 'tarefa-aberta' : ($tarefa->status == App\Models\Tarefa\StatusTarefa::FAZENDO ? 'tarefa-em-processo' : 'tarefa-concluida') }}" draggable="true" value="{{ $tarefa->id }}">
    <div class="task-header" style="display: flex; justify-content: space-between; width: 100%; padding: 5px 15px;">
        ...
        <div class="dropdown" style="position: relative;">
            <button class="btn-options" style="color: black;">
                <i class="bi bi-three-dots"></i> <!-- Ícone Bootstrap -->
            </button>
            <div class="dropdown-content">
                <!-- Botão de Visualizar -->
                <a href="{{ route('tarefa.show', ['tarefa' => $tarefa, 'url' => url()->current()]) }}" style="display: flex; align-items: center;">
                    <i class="bi bi-eye" style="margin-right: 8px;"></i> Visualizar
                </a>

                <!-- Botão de Editar -->
                <a href="{{ route('area-de-servico.equipe', ['area_de_servico' => $area_de_servico]) }}" style="display: flex; align-items: center;">
