    ...
    <div id="app" class="d-flex min-vh-100">
        ...
        <aside id="sidebar" class="bg-white text-dark p-3 position-fixed d-none" style="width: 300px; 
            ...
            <nav class="nav flex-column">
                ...
                <a class="btn d-flex align-items-center mb-2 {{ request()->is('area-de-servico') ? 'btn-primary' : 'btn-outline-primary' }}" href="/area-de-servico">
        ...
        <aside id="miniSidebar" class="bg-white d-flex flex-column position-fixed bg-light p-2 text-center" 
            ...
            <div class="d-flex flex-column align-items-center mt-4">
                ...
                <a href="/area-de-servico" class="text-dark mb-4 {{ request()->is('area-de-servico') ? 'btn-primary' : 'btn-outline-primary' }}">
