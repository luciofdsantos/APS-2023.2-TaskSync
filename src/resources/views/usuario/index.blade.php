                            ...
                            @foreach ($usuarios as $usuario)
                                <tr>
                                    ...
                                    <td class="action-icons">
                                        <a class="btn bi bi-pencil" href="{{ route('usuario.update', ['usuario'=>$usuario]) }}""></a>
                                    
                                        <a class="btn bi bi-eye"></a>
                                    
                                        <form method="post" action="{{ route('usuario.destroy', ['usuario' => $usuario]) }}" onsubmit="return confirm('Deseja excluir este usuário?')" style="display:inline-block;">
                                            @csrf
                                            @method('DELETE')
